...
const HomePage = props => {
    ...
    const slides2 = [
        ...
        {
            text:'Різноманіття солодких виробів: усе, що пропонує сучасне кондитерське мистецтво. Родзинка «L`ecler» — сучасні мусові мінідесерти, різних форм та відтінків. Вони гармонійно доповнять стилістику свята й посмакують усім запрошеним.'
        }
    ]
    return (
        <div className='HomePage' id='toTop'>
            ...
            <div className='tellLinksContainer'>
                <a href={'tel: +380960130541'}>+380960130541</a>
                <a href={'tel: +380980849649'}>+380980849649</a>
            </div>
                ...
                <div className='socialLinks'>
                    {
                        links.map((link,key) => {
                            return(
                                <a href={'https://www.instagram.com'} className='socialLink' key={key}>
                                    {link.name}
                                    {link.icon}
                                </a>
                            )
            ...
            <div className="itemsContainer" id='products'>
                {
                    props?.data
                        ? props.data.items.map( (item,key) => {
                            if (key >= 5 && key <= 14) {
                                return(
                                    <Link to={`/catalog#${key}`} className="item homeProductItem" key={key}>
                                                ...
                                                <div className="linksContainerContact">
                                                    {
                                                        links.map((link,key) => {
                                                            return(
                                                                <a href={'https://www.instagram.com'} className='socialLinkContact' key={key}>
                                                                    {link.name}
                                                                    {link.icon}
                                                                </a>
                                                            )
